...
3. попробовал тест с использованием testcontainers с попыткой поиска SQL-инъекций
...
С Testcontainers по сути до SQL-инъекций не дошел, т.к. сразу словил NPE, но по крайней мере потренировался с запуском Jazzer в этом режиме.
